...
func TestAnnotateHTTPRoute_WithChiRouteContext(t *testing.T) {
	...
	req := httptest.NewRequest("GET", "/api/v1/health", nil).WithContext(ctx)
...
func TestAnnotateHTTPRoute_NoRouteContext(t *testing.T) {
	...
	rec := httptest.NewRecorder()
	req := httptest.NewRequest("GET", "/some/path", nil).WithContext(ctx)
...
func TestAnnotateHTTPRoute_WithChiRouter(t *testing.T) {
	...
	rec := httptest.NewRecorder()
	req := httptest.NewRequest("GET", "/users/42", nil).WithContext(ctx)
